      ...
      <section className="mx-auto mt-5 max-w-[1600px] px-3 sm:px-4">
        <Reveal>
          <div className="card card-pad">
            <div className="flex items-center gap-2 rounded-2xl border border-bg-border bg-bg-900/60 p-1.5 shadow-inner">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {filters.map((f, i) => (
                <button key={f} className={i === 0 ? "chip border-brand-red/40 bg-brand-red/15 text-white" : "chip"}>
                  {f}
                </button>
              ))}
            </div>
          ...
          <div className="card card-pad relative overflow-hidden">
            ...
            <div className="relative mb-4 flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <p className="mt-0.5 text-sm font-semibold text-white">{comparison.product}</p>
              </div>
            ...
            <div className="relative grid grid-cols-[1fr_auto_auto] items-center gap-2 px-1 text-[10px] font-semibold uppercase tracking-wider text-white/40">
              <div>Enseigne</div>
                ...
                <li
                  ...
                  className={`grid grid-cols-[1fr_auto_auto] items-center gap-2 rounded-xl px-2 py-2.5 text-sm transition ${
                    s.best
                      ...
                      : "border border-white/5 bg-bg-800/40 hover:bg-bg-800/70"
                  }`}
                >
                  ...
                  <span className={`text-right font-extrabold tabular-nums ${s.best ? "text-brand-gold" : "text-white"}`}>
                    {s.price} <span className="text-[10px] font-normal text-white/40">DT</span>
                  </span>
                  <span className="w-24 text-right text-[11px] text-white/55">{s.stock}</span>
                </li>
              ))}
            </ul>
          </div>
