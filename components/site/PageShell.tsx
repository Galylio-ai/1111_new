        ...
        >
          ...
          <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-start gap-4">
              <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-gold/25 to-brand-gold/5 ring-1 ring-brand-gold/30 shadow-[0_0_30px_-8px_rgba(246,196,83,0.5)]">
            ...
            {chips && chips.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {chips.map((c) => (
                  <div key={c.label} className={`rounded-xl border px-3 py-2 ${toneMap[c.tone ?? "gold"]}`}>
