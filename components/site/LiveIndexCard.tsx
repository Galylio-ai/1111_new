  ...
  return (
    <div className="card card-pad relative overflow-hidden">
      ...
      <div className="relative mt-3 flex items-end gap-3">
        <div className="text-5xl font-black tracking-tight text-white tabular-nums transition-all duration-500 md:text-6xl">
          {current.toFixed(1)}
        </div>
      ...
      <div className="relative mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
        {stats.map((s) => (
          <div key={s.label} className="rounded-xl border border-bg-border bg-bg-800/70 p-3 transition hover:border-white/15">
