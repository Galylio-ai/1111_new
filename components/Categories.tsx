...
const categories = [
  {
    ...
    count: "4 200+",
    href: "/retail",
    image: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=600&h=800&fit=crop&q=90",
    from: "#1d4ed8",
    to: "#0ea5e9",
    text: "text-blue-300",
  ...
  },
  {
    ...
    count: "3 800+",
    href: "/retail",
    image: "https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=600&h=800&fit=crop&q=90",
    from: "#0891b2",
    to: "#06b6d4",
    text: "text-cyan-300",
  ...
  },
  {
    ...
    count: "12 000+",
    href: "/parapharmacie",
    image: "https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?w=600&h=800&fit=crop&q=90",
    from: "#be185d",
    to: "#f43f5e",
    text: "text-pink-300",
  ...
  },
  {
    ...
    count: "5 500+",
    href: "/parapharmacie",
    image: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=600&h=800&fit=crop&q=90",
    from: "#9d174d",
    to: "#ec4899",
    text: "text-rose-300",
  ...
  },
  {
    ...
    count: "900+",
    href: "/retail",
    image: "https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?w=600&h=800&fit=crop&q=90",
    from: "#1e3a8a",
    to: "#6366f1",
  ...
  },
  {
    ...
    count: "600+",
    href: "/retail",
    image: "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=600&h=800&fit=crop&q=90",
    from: "#991b1b",
    to: "#ef4444",
    text: "text-red-300",
  ...
  },
  {
    ...
    count: "1 200+",
    href: "/retail",
    image: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=600&h=800&fit=crop&q=90",
    from: "#065f46",
    to: "#34d399",
    text: "text-teal-300",
